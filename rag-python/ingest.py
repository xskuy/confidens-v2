...
def ingest_resource(
    ...
    # 300 tokens (~1200 chars) con 50 tokens overlap (~200 chars) para tamaño manejable
    text_splitter = RecursiveCharacterTextSplitter(
        chunk_size=1200,  # ~300 tokens para mejor contexto semántico sin ser excesivo
        chunk_overlap=200,  # ~50 tokens de overlap para sliding-window effect
        length_function=len,
